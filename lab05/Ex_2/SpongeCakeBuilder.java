...
public class SpongeCakeBuilder extends CakeBuilderMaster{
    public void addCreamLayer() {if(cake.getCakeLayers() > 1) cake.setmidLayerCream(Cream.Red_Berris);} // If there is more than one layer of cake we have cream between them
    ...
    public void addCakeLayer(){
        ...
        if(cake.getCakeLayers() == 1) cake.setCakeLayer("Sponge");                                      // If its the first layer of the cake we define the type of cake
    }
