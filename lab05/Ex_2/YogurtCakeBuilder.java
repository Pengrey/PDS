...
public class YogurtCakeBuilder extends CakeBuilderMaster{
    public void addCreamLayer() {if(cake.getCakeLayers() > 1) cake.setmidLayerCream(Cream.Vanilla);}    // If there is more than one layer of cake we have cream between them
    public void addTopLayer() {cake.settopLayerCream(Cream.Red_Berris) ;}                               // Sets cream for this type of cake     
    ...
    public void addCakeLayer(){
        ...
        if(cake.getCakeLayers() == 1) cake.setCakeLayer("Yogurt");                                      // If its the first layer of the cake we define the type of cake
    }
