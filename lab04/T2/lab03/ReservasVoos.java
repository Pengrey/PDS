...
public class ReservasVoos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Escolha a sua op��o: (H para ajuda)\n");
	...
	public static void getOption(String[] splitting) {
		String op��o = splitting[0].toUpperCase(); // comando dado pelo user
				...
				case "M":
					...
					for(int i = 0; i < flightCodes.size(); i++) {
						if(flightCode == flightCodes.get(i)) {
							char[][] seatDisposition = new char[nSeatsPerRow][nRows];	
