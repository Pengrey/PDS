...
public class Game implements JGaloInterface {
	...
	public boolean isFinished(){
        ...
        D2 = this.Jogadas[2][2] + this.Jogadas[1][1] + this.Jogadas[0][0];
        if(L1 == 3 || L2 == 3 || L3 == 3 || D1 == 3 || D2 == 3) this.Resultado = 'X'; 
        if(L1 == -3 || L2 == -3 || L3 == -3 || D1 == -3 || D2 == -3) this.Resultado = 'O';
        for(int i = 0 ; i < 3 ; i++){
            for(int j = 0 ; j < 3 ; j++){
